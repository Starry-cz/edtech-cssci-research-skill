...
| 4. 写作、诊断与修订 | `draft_review`、`section_revision`、`revision_cascade`、`reviewer_response_and_revision` | `references/writing-workflow.md`、`references/education-technology-empirical-writing-closure.md`、`references/revision-governance-and-style-diagnosis.md`、`references/publication-prose-and-style-control.md`、`assets/section-prompts/` |
...
6. 学习分析、课堂观察和可解释机器学习论文，先核对“理论—构念—指标/编码—表图—讨论—启示”是否闭合；模型比较、重要性和曲线只构成证据阶梯，不应成为正文目录。按需读取 `references/education-technology-empirical-writing-closure.md` 和 `assets/empirical-writing-closure-canvas.md`。
...
学习分析与可解释机器学习写作时，默认读取 `references/interpretable-machine-learning.md`、`references/education-technology-empirical-writing-closure.md`、`references/writing-workflow.md` 和相应章节模板；摘要再读取 `references/abstract-state-and-evidence-control.md` 与 `assets/abstract-argument-card-template.md`，其他章节从 `assets/section-prompts/abstract.md` 进入。方法质量、复现或投稿技术预审时，才将其中的审计部分作为独立交付。
