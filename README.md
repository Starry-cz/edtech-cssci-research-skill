...
> 写作按章节分工：摘要压缩研究判断，结果报告证据，讨论完成教学解释，局限集中说明真正改变结论的条件，结论回到题目形成最小推进。Skill 不使用固定“C 刊句式”或禁词表替代这种判断。

> 要求“最终版、可直接投稿”时，Skill 不会用“投稿时补充”“应如实说明”“待完善”等句子填补缺失的编码、授权、伦理、来源或作者信息。事实未齐时会阻断终稿，并将缺失项只列在稿外清单。
