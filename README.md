...
| **教育数据分析完整** | 覆盖数据审计、清理、描述与可视化、测量、推断、回归、SEM、多层与纵向分析 | 只报 p 值、忽略构念质量、班级聚类、时间结构和不确定性 |
...
| 4. 研究设计与数据 | 选择范式，界定样本、测量、数据生成、分析单位、清洗、模型与识别条件 | 研究设计、数据字典、分析计划、伦理与权限清单 | [研究范式](references/research-paradigms.md) · [教育数据分析](references/education-data-analysis.md) · [分析报告模板](assets/education-data-analysis-report-template.md) |
...
| [`assets/education-data-analysis-report-template.md`](assets/education-data-analysis-report-template.md) | 教育数据分析计划与结果报告 |
...
| 教育数据分析 | 数据审计 + 分析计划 + 描述/测量/模型结果 + 诊断、稳健性与复现边界 |
