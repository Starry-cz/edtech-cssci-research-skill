...
| 5. 结果、讨论与写作 | 搭主论证、组织题目、摘要、引言、综述、方法、结果、讨论和结论 | 论证工作底稿、正文章节、证据边界说明、章节结尾 | [论文论证与重构](references/academic-writing-and-revision.md) · [写作工作流](references/writing-workflow.md) · [章节收束](references/chapter-synthesis.md) |
