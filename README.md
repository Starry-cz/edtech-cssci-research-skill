...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/39-研究参考模块-2563eb.svg" alt="39 个研究参考模块" />
...
| 4. 写作、诊断与修订 | 如何将证据写成可审查的论证，并修复核心缺陷 | 全文诊断、章节修订、修订连锁、审稿回应 | [写作工作流](references/writing-workflow.md) · [章节模板](assets/section-prompts/abstract.md) · [论文论证与重构](references/academic-writing-and-revision.md) |
...
| 6. 诊断、返修与回应 | 全文诊断、框架防御、多审稿人意见处理、修订连锁与版本传播检查 | 修订报告、回应函、修改台账 | [终稿自检](references/self-review.md) · [修订治理](references/revision-and-reviewer-response.md) · [修订台账模板](assets/reviewer-response-and-revision-ledger-template.md) |
...
| 全文诊断 | 总体判断 + `Pass / Partial / Fail` + 定位证据 + 表层问题 + 修改路径 | 确定关键缺口、修订顺序和清洁稿放行条件 |
