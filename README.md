...
| 5. 结果、讨论与写作 | 搭主论证、组织题目、摘要、引言、综述、方法、结果、讨论和结论，并将内部构思转换为投稿清洁稿 | 论证工作底稿、清洁正文章节、分离的修改说明、表层审计、章节结尾 | [论文论证与重构](references/academic-writing-and-revision.md) · [写作工作流](references/writing-workflow.md) · [投稿正文与表层控制](references/publication-prose-and-style-control.md) · [表层审计模板](assets/manuscript-surface-audit-template.md) · [章节收束](references/chapter-synthesis.md) |
